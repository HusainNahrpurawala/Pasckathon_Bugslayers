...
class Positive extends Component{
  ...
  left: "480px",
  top: "-5px",
  textDecoration:"underline", color:" #F5F5DC"}}>SEPSIS POSITIVE</h1>
              
           
          
           <p style={{positon: "absolute", marginTop:"5%", marginRight:"-15px", backgroundColor:"#FFE4C4", paddingLeft:"14px", paddingRight:"12px", fontFamily:"Bookman, URW ", fontSize:"18px"}}>    Early, aggressive treatment boosts your chances of surviving sepsis. People who have sepsis require close monitoring and treatment in a hospital intensive care unit. If you have sepsis 
...
A number of medications are used in treating sepsis and septic shock. They include:
    ...
    After learning the results of blood tests, your doctor may switch to a different antibiotic that's targeted to fight the particular bacteria causing the infection.
     People who have sepsis often receive intravenous fluids right away, usually within three hours.
